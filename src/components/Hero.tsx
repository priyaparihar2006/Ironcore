...
export const Hero: React.FC<HeroProps> = ({ onJoinNow }) => {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      {/* Main Hero Section */}
      <main className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 pt-4 sm:pt-6 pb-8 sm:pb-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center pb-4 lg:pb-12">
          ...
          {/* Top Micro Badge */}
          <div className="mb-6">
            <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-[var(--color-primary)]/20 text-[var(--color-text-main)] text-xs font-bold uppercase tracking-wider">
          ...
          {/* Supporting Text */}
          <p className="text-lg sm:text-xl text-[var(--color-text-main)]/60 max-w-md leading-relaxed mb-10 font-normal">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6">
            <button
              onClick={onJoinNow}
              id="hero-primary-cta"
              className="bg-[var(--color-primary)] text-[var(--color-text-main)] px-8 sm:px-10 py-4 sm:py-5 rounded-lg text-base sm:text-lg font-bold shadow-sm shadow-purple-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-center"
            >
              Join Now
            </button>
            <a
              ...
              className="bg-white/80 border border-gray-900/10 backdrop-blur-md px-8 sm:px-10 py-4 sm:py-5 rounded-lg text-base sm:text-lg font-bold text-[var(--color-text-main)] hover:bg-white transition-all text-center"
            >
              Explore Programs
            </a>
          </div>
          ...
          <div className="relative w-full max-w-[480px] sm:max-w-[540px] h-[520px] sm:h-[600px] flex items-center justify-center">
            ...
            <div className="hidden lg:block absolute top-16 -left-8 bg-white/90 backdrop-blur-xl p-6 rounded-lg shadow-sm border border-white/50 w-44 z-20 transition-transform hover:scale-105 duration-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="text-xs font-bold text-[var(--color-text-muted)] tracking-wider uppercase">
                  CALORIES
                </div>
              </div>
            ...
            <div className="hidden lg:flex absolute bottom-8 left-6 bg-white/90 backdrop-blur-xl p-6 rounded-lg shadow-sm border border-white/50 items-center gap-3 z-20 transition-transform hover:scale-105 duration-200">
              ...
              <div>
                ...
                <div className="text-base font-bold text-[var(--color-text-main)]">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-6 w-full max-w-[480px] sm:max-w-[540px] lg:hidden">
            ...
            <div className="w-full min-w-0 bg-white/90 backdrop-blur-xl p-3 sm:p-6 rounded-lg shadow-sm border border-white/50 transition-transform hover:scale-105 duration-200">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                ...
                <div className="text-xs sm:text-xs font-bold text-[var(--color-text-muted)] tracking-wider uppercase truncate">
                  CALORIES
                </div>
              </div>
              <div className="text-lg sm:text-2xl font-bold text-[var(--color-text-main)] truncate">
                1,200 <span className="text-xs font-bold opacity-40">kcal</span>
              </div>
            </div>

            {/* Daily Steps */}
            <div className="w-full min-w-0 bg-white/90 backdrop-blur-xl p-3 sm:p-6 rounded-lg shadow-sm border border-white/50 flex items-center gap-2.5 sm:gap-6 transition-transform hover:scale-105 duration-200">
              <div className="w-2 h-8 sm:h-10 shrink-0 bg-emerald-400 rounded-full" />
              <div className="min-w-0">
                <div className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider truncate">
                  DAILY STEPS
                </div>
                <div className="text-sm sm:text-lg font-bold text-[var(--color-text-main)] truncate">
                  11,980
                </div>
              </div>
            </div>
            ...
            {/* Target Weight */}
            <div className="w-full min-w-0 bg-white/90 backdrop-blur-xl p-3 sm:p-6 rounded-lg shadow-sm border border-white/50 flex items-center gap-2.5 sm:gap-3 transition-transform hover:scale-105 duration-200">
              ...
              <div className="min-w-0">
                ...
                <div className="text-sm sm:text-base font-bold text-[var(--color-text-main)] truncate">
                  70 <span className="text-xs font-semibold opacity-40">kg</span>
                </div>
              </div>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 pb-12 pt-4 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="bg-white/60 backdrop-blur-lg border border-white p-8 rounded-lg flex items-center justify-between shadow-xs hover:shadow-sm transition-shadow">
            <div className="flex items-center gap-6">
              <div className="w-12 h-12 bg-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-sm tracking-tighter">
                IC
              </div>
              <div>
                <div className="text-sm font-bold text-[var(--color-text-main)]">Workout Streak</div>
            ...
            <div className="flex gap-1.5">
              ...
              <div className="w-7 h-7 rounded-lg bg-[var(--color-brand-bg)]0 shadow-2xs" />
          ...
          <div className="bg-white/60 backdrop-blur-lg border border-white p-8 rounded-lg flex items-center justify-between shadow-xs hover:shadow-sm transition-shadow">
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="text-sm font-bold text-[var(--color-text-main)]">Hydration Level</div>
          ...
          <div className="bg-black p-8 rounded-lg flex items-center justify-between text-white shadow-sm">
            <div>
              <div className="text-sm font-bold">Membership</div>
              <div className="text-xs opacity-60 text-purple-200">Elite Tier Plan</div>
            </div>
            <div className="bg-white/10 px-3 py-1 rounded-full text-xs font-bold tracking-widest uppercase text-white/90">
              Active
            </div>
          </div>
