...
export const TestimonialsSection: React.FC = () => {
  return (
    <section id="testimonials" className="w-full px-4 md:px-8 lg:px-12 py-16 sm:py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-8">
          {TESTIMONIALS.map((item) => (
            <div
              key={item.id}
              className="relative rounded-[28px] bg-white border border-[var(--color-border-main)]/80 p-7 sm:p-8 shadow-xs hover:shadow-sm hover:border-[var(--color-border-main)] transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                {/* Rating & Quote Icon */}
                ...
                <div className="mb-6 inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-[var(--color-brand-bg)] text-purple-800 text-xs font-bold">
              ...
              <div className="pt-5 border-t border-neutral-100 flex items-center gap-3.5">
                ...
                <div>
                  ...
                  <span className="text-xs text-[var(--color-text-main)] font-semibold">{item.duration}</span>
                </div>
              </div>
